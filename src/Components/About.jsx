const About = () => {
    return (
        <div className="px-10 md:px-28 h-screen flex items-center justify-between z-10 overflow-hidden">
            <div className="pt-20 pb-10 flex flex-col gap-6">
                <h1 className="text-5xl text-zinc-800 font-semibold animate-in slide-in-from-top-60 duration-500">{`Hi there! I'm Rajat`}</h1>
            ...
            <img src="/user.png" alt="" className="animate-in slide-in-from-right-96 duration-500" />
        </div>
    )
}
