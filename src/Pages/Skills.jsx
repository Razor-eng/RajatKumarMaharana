        ...
        <div className="px-3 md:px-28 py-2 z-10 overflow-x-hidden min-h-screen max-w-screen dark:text-white">
            <div className="flex w-full justify-end">
                <div className="w-44 flex items-center px-2 py-1 rounded-xl bg-rose-50 focus-within:w-full md:focus-within:w-72 focus-within:outline focus-within:outline-blue-600 transition-all ease-in duration-200">
                    ...
                    <input type="text" className="w-full bg-transparent pl-1 outline-none placeholder-zinc-400 dark:text-black" placeholder="Search Skills" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
                </div>
            </div>
